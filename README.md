# FUSuWangDemoDroid 快速接入文档

FUSuWangDemoDroid 是集成了 FaceUnity 美颜道具贴纸功能和网宿推流的 Demo。

本文是 FaceUnity SDK 快速对接网宿推流的导读说明，关于 `FaceUnity SDK` 的详细说明，请参看 **[FULiveDemoDroid](https://github.com/Faceunity/FULiveDemoDroid/)**
...
上面一系列方法的使用，具体在 demo 中的 `FaceUnityFilter` 类和 `MainActivity` 类，请参考该代码示例接入。
